...
<!-- Filtros -->
<div class="vot-filtros">
    <form method="GET" action="home.php">
        <input type="hidden" name="pg" value="<?= $pg; ?>">
        <div class="row g-3 align-items-end">
            <div class="col-md-5">
                <label for="fidcen" class="form-label"><i class="fas fa-building me-1"></i> Centro de Formación</label>
            ...
            <div class="col-md-5">
                <label for="fidfic" class="form-label"><i class="fas fa-id-card me-1"></i> Ficha</label>
            ...
            <div class="col-md-2">
                <a href="home.php?pg=<?= $pg; ?>" class="btn btn-outline-secondary w-100">
